...
| 028 - Performance ingestion and review | Partial | Backend tests 17/17; backend ruff; frontend typecheck; diff check | Provider-neutral evidence ingestion, structured provider payload parsing, WHOOP/Garmin/Apple Health/Fitbit schema normalization, metric-specific narrative parsing, parser confidence/warning metadata, pending-review observations, human review/correction, and console controls are implemented; credentialed provider sync, more vendor schemas, model-backed extraction, and full verification remain. |
...
10. Add credentialed provider sync, more provider-specific schemas, wearable
   webhook replay protection, and model-backed extraction accuracy evaluation.
