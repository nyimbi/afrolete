...
| Travel and logistics | partial | Event travel plans now cover trip itinerary, transport mode, route, driver/vehicle checks, digital inspection checklists, manifests, CSV/text offline manifest exports, lodging, meals, equipment, emergency contacts, medical access, consent timing, guardian travel consent request generation, operator-triggered guardian reminders, safety manifests, cost estimates, trip fee invoice generation, travel fee checkout links, approval workflow records, automated approval routing, provider-neutral GPS/location tracking updates, departure/delay/arrival/return notifications, geofence breach checks, trip expense/reimbursement records with receipt uploads, carpool requests/offers, departure readiness gating, deterministic route optimization, risk scoring, and status controls; hardware GPS ingestion, persistent geofence zones, automatic geographic carpool matching, live map provider routing, traffic-aware/weather-aware rerouting, driver ratings, backup driver networks, payout execution, payment processor sessions, scheduled reminder automation, checklist photo uploads, map rendering, signed offline links, PDF layouts, and mobile offline cache remain. |
