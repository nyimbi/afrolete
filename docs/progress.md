...
| Consent, safeguarding, compliance, incidents | partial | Guardian relationships, consent requests, one-use web links, SMS/WhatsApp/Telegram/email/manual consent capture, family portal consent responses, minor event clearance, and operator incident reporting/triage are implemented; background checks, investigation workflows, regulatory submission packages, and advanced compliance dashboards remain. |
