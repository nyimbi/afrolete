...
| Events, schedules, attendance | partial | Event scheduling APIs, roster invitation seeding, attendance recording/listing, consent-aware check-in, event weather safety assessments, weather alert dispatch, travel planning/risk workflows, event travel consent generation, guardian travel consent reminders, travel safety manifests, trip fee invoice generation, and travel approval workflows are implemented. |
