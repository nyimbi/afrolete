...
| 216 - Performance goals and achievements | Partial | Focused backend/frontend checks; migration authored | Athlete performance now supports persisted metric goals, target/baseline/current tracking, direction-aware achieved status, achievement evaluation, generated goal-achieved awards, personal-best awards, badge codes, award history, and operations-console controls/cards for creating goals and scanning achievements; family/player-facing celebration surfaces, social sharing, richer badge design, scheduled achievement scans, browser QA, and full backend tests remain. |
| 217 - Family performance celebration surface | Partial | Focused backend/frontend checks | The family portal now has a guardian-scoped performance endpoint and UI section that exposes linked athletes' active goals, achieved goals, awards, badge codes, personal-best/goal achievement summaries, and headline goal/award counts without leaking unrelated athletes; richer visual badge design, social sharing, player self-service surfaces, scheduled achievement scans, browser QA, and full backend tests remain. |
