...
| Consent, safeguarding, compliance, incidents | partial | Guardian relationships, SDK guardian linking, SDK consent request creation, consent requests, one-use web links, SMS/WhatsApp/Telegram/email/manual consent capture, family portal consent responses, minor event clearance, event travel consent request generation and reminders, travel safety manifests with guardian and medical clearance context, background-check tracking with provider-specific screening submission adapters and provider-sourced screening risk/status intake, compliance credential renewal tracking, derived compliance dashboards, manual and scheduled expiry reconciliation, blocker/renewal/investigation queues, operator incident reporting/triage, developer OAuth replay security incidents, emergency activation incident generation, regulatory report packages with Markdown/PDF exports, persisted object storage, signed artifact links, provider-neutral regulatory submission with provider-specific schema profiles, incident insurance claim tracking with provider-neutral submission/status adapters and provider-specific schema profiles, return-to-play medical clearance with provider-neutral medical portal sync and provider-specific schema profiles, and medical-clearance-aware attendance gating are implemented; deeper investigation workflows, live screening provider credentials/replay, evidence document review, live government portal credentials/replay, live insurer credentials/replay, live medical portal credentials/replay, richer attendance policy configuration, and access-control automation remain. |
