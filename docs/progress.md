...
4. Add MinIO-backed equipment storage, live RFID reader gateway provisioning,
   supplier API submission, and accounting lease billing for assets and
   facilities.
