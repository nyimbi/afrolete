...
| Travel and logistics | partial | Event travel plans now cover trip itinerary, transport mode, route, driver/vehicle checks, digital inspection checklists, manifests, CSV/text offline manifest exports, lodging, meals, equipment, emergency contacts, medical access, consent timing, guardian travel consent request generation, operator-triggered guardian reminders, safety manifests, cost estimates, trip fee invoice generation, approval workflow records, provider-neutral GPS/location tracking updates, departure/delay/arrival/return notifications, trip expense/reimbursement records, carpool requests/offers, departure readiness gating, deterministic route optimization, risk scoring, and status controls; hardware GPS ingestion, geofencing, automatic geographic carpool matching, live map provider routing, traffic-aware/weather-aware rerouting, driver ratings, backup driver networks, live receipt uploads, payout execution, online payment collection, automated approval routing, scheduled reminder automation, checklist photo uploads, map rendering, signed offline links, PDF layouts, and mobile offline cache remain. |
| Finance, sponsorship, fundraising, ticketing | partial | Sponsors, sponsorship agreements, fundraising campaigns, donations, ticket products/orders/QR tickets/check-in, invoices, trip fee invoices, travel expense reimbursement records, payments, settlement summaries, refunds, tax quotes, accounting exports, sponsorship dashboards, commercial summary, and console workflows are implemented; live payment provider webhooks, payment links/checkout, reimbursement payout execution, tax authority filing, accounting API sync, and sponsor-facing dashboards remain. |
