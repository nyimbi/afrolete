...
| 074 - Incident regulatory report packages | Partial | Backend ruff; frontend typecheck; diff check | Reportable safeguarding incidents can now generate auditable regulatory packages with agency, jurisdiction, due date, narrative, checklist payload, submission payload, external reference, draft/ready/submitted/accepted/rejected workflow controls, and Markdown/PDF exports in the console; electronic government portal submission remains. |
