...
| Finance, sponsorship, fundraising, ticketing | partial | Sponsors, sponsorship agreements, fundraising campaigns, donations, ticket products/orders/QR tickets/check-in, invoices, trip fee invoices, travel fee checkout links, hosted sponsor invoice checkout sessions, signed commercial invoice payment webhooks, travel expense reimbursement records with receipt evidence and payout execution, payments, settlement summaries, signed commercial settlement payouts, refunds, tax quotes, signed commercial tax filing, accounting exports and signed accounting sync, sponsorship dashboards, commercial summary, public support showcases on branded organization sites, authenticated sponsor self-service dashboards, and console workflows are implemented; live payment provider redirects/replay credentials, live payout-provider credential replay, live tax-authority replay credentials, live accounting-provider replay credentials, and full commercial browser QA remain. |
...
5. Add live payment provider redirect creation/replay credentials, live
   payout-provider replay credentials, live tax-authority replay credentials,
