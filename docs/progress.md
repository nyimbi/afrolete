...
4. Add MinIO-backed equipment storage, live RFID reader gateway provisioning,
   supplier-specific adapters, supplier invoice sync, and accounting lease
   billing for assets and facilities.
