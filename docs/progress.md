...
10. Add provider-specific backoff policies, more provider-specific schemas,
   provider webhook registration smoke tests, browser visual QA, live wearable
   provider smoke tests, live provider webhook registration smoke tests, and
   model-backed extraction accuracy evaluation.
