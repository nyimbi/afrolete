...
- SaaS billing and subscriptions: AfroLete hosting plans paid by the tenant
  ...
  charge cycles, per-period balances, payment allocation, aging summaries, auditable waivers, downloadable/deliverable member account statements, payment links, reminders, lifecycle controls, and
