...
- Finance, sponsorship, fundraising, ticketing, invoices, payments, refunds,
  ...
  recurring charge ledgers with payment allocation, receivables aging summaries, hosted dues payment links, scheduled dues reminders, and venue
...
- SaaS billing and subscriptions: AfroLete hosting plans paid by the tenant
  ...
  charge cycles, per-period balances, payment allocation, aging summaries, payment links, reminders, and
