...
- Finance, sponsorship, fundraising, ticketing, invoices, payments, refunds,
  ...
  recurring charge ledgers with payment allocation, receivables aging summaries, auditable waivers, downloadable member account statements, hosted dues payment links, scheduled dues reminders, and venue
...
- SaaS billing and subscriptions: AfroLete hosting plans paid by the tenant
  ...
  charge cycles, per-period balances, payment allocation, aging summaries, auditable waivers, downloadable member account statements, payment links, reminders, and
