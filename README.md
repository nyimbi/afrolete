...
- Consent, safeguarding, minor participation clearance, family portals,
  ...
  verification, scheduled renewal reminders, insurer claim workflows, and
...
- SaaS billing and subscriptions: AfroLete hosting plans paid by the tenant
  ...
  charge cycles, per-period balances, payment allocation, over/early-payment credits that apply to future club dues, credit refunds for returning excess balances, aging summaries, payment plans, renewal campaigns with early-bird offers, financial-aid awards, renewals, appeals, and impact reporting, auditable waivers, downloadable/deliverable member account statements, payment links, reminders, lifecycle controls, and
...
idempotent reuse on repeated coach clicks, scheduled training sessions for each
...
so coach curation governs what appears in downstream reels. Timeline JSON,
edit-decision exports, and caption packs also carry curation summaries,
per-clip review status, and editor overlays so downstream renderers and
recipients can distinguish coach-featured, approved, and AI-detected clips. The
same match analysis pipeline now
...
with player and ball dots, recent trails, a time slider, and team color legend
for coach review.
