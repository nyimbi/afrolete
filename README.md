...
- Finance, sponsorship, fundraising, ticketing, invoices, payments, refunds,
  ...
  donor CRM and stewardship, grant application internal approvals, financial
  budgeting, forecasting, management financial statements, club-managed member
  dues with M-Pesa/mobile-money collection support, and venue digital-signage
  sponsor rotations with playback telemetry.
