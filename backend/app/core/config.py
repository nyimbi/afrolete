...
class Settings(BaseSettings):
    ...
    billing_dunning_webhook_key_secret_path: str = ""
    billing_dunning_webhook_key_secret_field: str = "value"
    ...
    commercial_payment_session_mode: Literal["local", "webhook"] = "local"
    commercial_payment_session_webhook_url: str = ""
    commercial_payment_session_webhook_key: str = ""
    commercial_payment_session_webhook_key_secret_path: str = ""
    commercial_payment_session_webhook_key_secret_field: str = "value"
    commercial_payment_session_timeout_seconds: float = 5.0
    ...
    commercial_payout_delivery_mode: Literal["record_only", "webhook"] = "record_only"
    commercial_payout_webhook_url: str = ""
    commercial_payout_webhook_key: str = ""
    commercial_payout_webhook_key_secret_path: str = ""
    commercial_payout_webhook_key_secret_field: str = "value"
    commercial_payout_timeout_seconds: float = 5.0
    commercial_payout_callback_signing_key: str = ""
    commercial_payout_callback_signing_key_secret_path: str = ""
    commercial_payout_callback_signing_key_secret_field: str = "value"
    commercial_payout_callback_tolerance_seconds: int = 300
    ...
    safeguarding_regulatory_report_webhook_key_secret_path: str = ""
    safeguarding_regulatory_report_webhook_key_secret_field: str = "value"
    safeguarding_regulatory_report_timeout_seconds: float = 5.0
    safeguarding_regulatory_report_provider_profile: str = "auto"
    ...
    safeguarding_insurance_claim_provider_profile: str = "auto"
    ...
    safeguarding_medical_clearance_provider_profile: str = "auto"
