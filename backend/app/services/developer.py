...
from app.schemas.developer import (
    ...
    DeveloperSdkEndpointCatalogRead,
...
def developer_scope_catalog() -> list[DeveloperApiScopeCatalogRead]:
    return [
        ...
        DeveloperApiScopeCatalogRead(
            ...
            category="events",
            description="Read event attendance records through SDK routes.",
            recommended_for=["attendance kiosks", "school SIS sync", "matchday operations"],
        ),
        DeveloperApiScopeCatalogRead(
            scope="write:attendance",
            category="events",
            description="Record event attendance through SDK routes while preserving tenant attendance policy gates.",
            recommended_for=["attendance kiosks", "turnstile integrations", "school trip imports"],
        ),
        DeveloperApiScopeCatalogRead(
            scope="read:teams",
            category="teams",
        ...
        DeveloperApiScopeCatalogRead(
            scope="read:agents",
            category="ai_agents",
            description="Read tenant AI agents and governed agent task status through SDK routes.",
            recommended_for=["AI orchestration", "coach copilots", "operations dashboards"],
        ),
        DeveloperApiScopeCatalogRead(
            scope="write:agents",
            category="ai_agents",
            description="Queue governed tenant AI agent tasks through SDK routes.",
            recommended_for=["AI orchestration", "scouting automations", "training copilots"],
        ),
        DeveloperApiScopeCatalogRead(
...
def developer_webhook_event_catalog() -> list[DeveloperWebhookEventCatalogRead]:
    return [
        ...
        DeveloperWebhookEventCatalogRead(
            event_type="agents.task.queued",
            category="ai_agents",
            description="A developer API key queued a governed task for a first-class AfroLete AI agent.",
            emission_status="active",
            payload_fields=[
                "organization_id",
                "agent_id",
            ...
            recommended_scopes=["write:agents"],
            example_payload={
                "organization_id": "tenant-uuid",
                "agent_id": "agent-uuid",
                "task_id": "task-uuid",
                ...
                "status": "queued",
                "governance_policy_code": "training-ai-approval",
                "governance_policy_decision": "require_approval",
                "origin": "developer_api",
            },
        ),
        DeveloperWebhookEventCatalogRead(
...
def developer_sdk_endpoint_catalog() -> list[DeveloperSdkEndpointCatalogRead]:
    endpoint_rows = [
        (
            "GET",
            "/sdk/me",
            "auth",
            "Inspect the active API key, application, scopes, quota, and counter mode.",
            [],
            "client.me",
            "client.me",
            [],
        ...
        (
            ...
            "/sdk/organization",
            "organization",
            "Read tenant organization identity, branding, contact, and platform metadata.",
            ["read:organization"],
        ...
        (
            ...
            "/sdk/people",
            "people",
            "Create or reuse tenant people for roster, guardian, and member imports.",
            ["write:people", "write:roster"],
        ...
        (
            "POST",
            "/sdk/people/{athlete_person_id}/guardians",
            "people",
            "Link parents or guardians to athlete records with consent authority flags.",
        ...
        (
            "POST",
            "/sdk/people/{athlete_person_id}/consent-requests",
            "people",
            "Create one-use guardian consent requests for events, teams, or organizations.",
        ...
        (
            ...
            "/sdk/teams",
            "teams",
            "List tenant teams for directory sync and roster targeting.",
            ["read:organization", "read:teams"],
            "client.teams.list",
            "client.teams.list",
            [],
        ),
        (
            ...
            "/sdk/teams",
            "teams",
            "Create tenant teams while preserving organization-team relationships.",
            ["write:teams"],
            "client.teams.create",
            "client.teams.create",
            [],
        ...
        (
            "POST",
            "/sdk/teams/{team_id}/members",
            "teams",
            "Assign existing people to team rosters and create athlete profiles as needed.",
            ["write:roster", "write:teams"],
        ...
        (
            ...
            "/sdk/events",
            "events",
            "List tenant events with optional team filtering.",
        ...
        (
            ...
            "/sdk/events",
            "events",
            "Create tenant schedule events from trusted partner systems.",
            ["write:events"],
        ...
        (
            "GET",
            "/sdk/events/{event_id}/attendance",
            "attendance",
            "List attendance records for event kiosks and matchday sync.",
            ["read:attendance", "write:attendance"],
            "client.events.attendance.list",
            "client.events.attendance.list",
            [],
        ),
        (
            ...
            "/sdk/events/{event_id}/attendance",
            "attendance",
            "Record event attendance while preserving tenant policy gates.",
            ["write:attendance"],
        ...
        (
            ...
            "/sdk/agents",
            "ai_agents",
            "List tenant AI agents available to trusted integrations.",
        ...
        (
            ...
            "/sdk/agents/tasks",
            "ai_agents",
            "List governed AI-agent task status for integration handoff tracking.",
            ["read:agents", "write:agents"],
        ...
        (
            "POST",
            "/sdk/agents/{agent_id}/tasks",
            "ai_agents",
            "Queue governed AI-agent work from trusted external systems.",
            ["write:agents"],
        ...
        (
            ...
            "/sdk/communications/templates",
            "communications",
            "Create tenant communication templates for partner workflows.",
        ...
        (
            "GET",
            "/sdk/communications/messages",
            "communications",
            "List tenant communication messages and recipient counts.",
            ["read:communications", "write:communications"],
        ...
        (
            ...
            "/sdk/communications/messages",
            "communications",
            "Create scoped tenant messages from partner systems.",
            ["write:communications"],
        ...
        (
            "GET",
            "/sdk/communications/messages/{message_id}/recipients",
            "communications",
            "Inspect expanded recipients for a tenant message.",
            ["read:communications", "write:communications"],
        ...
        (
            "POST",
            "/sdk/communications/messages/{message_id}/dispatch",
            "communications",
            "Dispatch a prepared message through configured tenant delivery adapters.",
            ["write:communications"],
        ...
        (
            ...
            "/sdk/billing/plans",
            "billing",
            "List tenant-paid AfroLete hosting plans for provisioning sync.",
        ...
        (
            "GET",
            "/sdk/billing/subscriptions",
            "billing",
            "List tenant-paid AfroLete hosting subscriptions.",
            ["read:billing", "write:billing"],
        ...
        (
            ...
            "/sdk/billing/usage",
            "billing",
            "Record metered usage from partner systems.",
            ["write:billing"],
        ...
        (
            "GET",
            "/sdk/billing/invoices",
            "billing",
            "List tenant-paid AfroLete hosting invoices.",
            ["read:billing", "write:billing"],
        ...
        (
            "GET",
            "/sdk/billing/entitlements",
            "billing",
            "List tenant feature entitlements and current usage state.",
            ["read:billing", "write:billing"],
        ...
        (
            ...
            "/sdk/billing/summary",
            "billing",
            "Read tenant billing summary metrics.",
            ["read:billing", "write:billing"],
        ...
        (
            ...
            "performance",
            "List tenant performance metric definitions.",
        ...
        (
            "GET",
            "/sdk/performance/athletes/{athlete_profile_id}/observations",
            "performance",
            "List athlete performance observations.",
            ["read:performance", "write:performance"],
        ...
        (
            ...
            "/sdk/performance/athletes/{athlete_profile_id}/observations",
            "performance",
            "Submit provider-sourced athlete performance observations.",
            ["write:performance"],
        ...
        (
            ...
            "/sdk/training/drills",
            "training",
            "List tenant training drills.",
            ["read:organization", "read:training"],
        ...
        (
            ...
            "/sdk/training/drills",
            "training",
            "Create tenant training-library drills.",
            ["write:training"],
        ...
        (
            ...
            "/sdk/training/plans",
            "training",
            "List tenant training plans with team or athlete filtering.",
            ["read:training", "write:training"],
        ...
        (
            ...
            "/sdk/training/plans",
            "training",
            "Create tenant training plans from partner coaching systems.",
            ["write:training"],
        ...
        (
            "GET",
            "/sdk/training/plans/{plan_id}/items",
            "training",
            "List plan items for a tenant training plan.",
            ["read:training", "write:training"],
        ...
        (
            ...
            "/sdk/training/plans/{plan_id}/items",
            "training",
            "Add drills or custom activities to a tenant training plan.",
            ["write:training"],
        ...
        (
            "GET",
            "/sdk/training/sessions",
            "training",
            "List scheduled tenant training sessions.",
            ["read:training", "write:training"],
        ...
        (
            ...
            "/sdk/training/sessions",
            "training",
            "Create scheduled tenant training sessions.",
            ["write:training"],
        ...
        (
            "GET",
            "/sdk/training/sessions/{session_plan_id}/feedback",
            "training",
            "List post-session athlete feedback records.",
            ["read:training", "write:training"],
        ...
        (
            ...
            "/sdk/training/sessions/{session_plan_id}/feedback",
            "training",
            "Record post-session feedback and readiness data.",
            ["write:training"],
        ...
        (
            "POST",
            "/sdk/training/availability",
            "training",
            "Suggest schedule windows for tenant training sessions.",
            ["read:training", "write:training"],
        ...
        (
            "GET",
            "/sdk/training/calendar-artifact",
            "training",
            "Export checksumed iCalendar training artifacts.",
            ["read:training", "write:training"],
    ...
    return [
        DeveloperSdkEndpointCatalogRead(
            ...
            typescript_entry_point=typescript_entry_point,
    ...
    return [
        ...
        DeveloperSdkCatalogRead(
            ...
            entry_points=[
                ...
                "GET /sdk/events",
                "POST /sdk/events",
                "GET /sdk/events/{event_id}/attendance",
                "POST /sdk/events/{event_id}/attendance",
                "GET /sdk/agents",
